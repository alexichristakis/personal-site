...
const Design = () => (
  <Element className="section-container design" name="design">
    <h1>Design</h1>
    <h2>Accordion</h2>
    <p>
      Project done for ART 469b: Advanced Graphic Design. Students chose a
      designer to write about in an 'accordion' format restricted only by the
      limitation of printing on a single side. My accordion (on Ralph
      Schraivogel) contains 5 sections: training & work, stylistic regularities,
      influence & context, Henry Van de Velde, and grayscale series. I designed
      the folding to accomodate a variety of opening possibilities which each
      allow for a different experience. The final product was produced on an
    ...
    <p>
      Zine done for ART 368a: Graphic Design Methodologies. Images of abandoned
      or decrepit bikes in New Haven were collected over the course of the
      semester.
    </p>
    <div className="pages">
